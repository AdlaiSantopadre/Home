...
-define(STATE, #{setup_done => false, modules_distributed => false}).
...
process_option("3", State) ->
    ...
    ModulesDistributed = maps:get(modules_distributed, State),
    case {SetupDone, ModulesDistributed} of
        {true, true} ->
