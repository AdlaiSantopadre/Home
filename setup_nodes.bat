...
start powershell -NoExit -Command "& erl -sname Alice@DESKTOPQ2A2FL7 -setcookie %COOKIE% -pa %BASE_DIR% -config sys"

REM Avvia il nodo 2 in una nuova finestra di PowerShell
start powershell -NoExit -Command "& erl -sname Bob@DESKTOPQ2A2FL7 -setcookie %COOKIE% -pa %BASE_DIR% -config sys"

REM Avvia il nodo 3 in una nuova finestra di PowerShell
start powershell -NoExit -Command "& erl -sname Charlie@DESKTOPQ2A2FL7 -setcookie %COOKIE% -pa %BASE_DIR -config sys%"
