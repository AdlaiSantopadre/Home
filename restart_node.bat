...
start powershell -NoExit -Command "& erl -sname %NODE_NAME%@DESKTOPQ2A2FL7 -setcookie %COOKIE% -pa %EBIN_DIR% -pa %SRC_DIR% -config %BASE_DIR%\config\%NODE_NAME%  -eval restart_node:init`(`)."
